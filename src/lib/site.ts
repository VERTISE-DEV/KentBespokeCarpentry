...
export const SERVICES: Service[] = [
  ...
  { title: "Media walls & fireplaces", body: "Recessed television and fireplace walls with lit display niches, concealed cabling and painted or veneered finishes, designed around the proportions of the room rather than a standard unit size.", bg: "#0e2140", fg: "#fff" },
  ...
  { title: "Fitted wardrobes & alcoves", body: "Floor-to-ceiling wardrobes, alcove units and under-stair storage, designed around what needs to go inside them rather than around a standard carcass.", bg: "#0e2140", fg: "#fff" },
